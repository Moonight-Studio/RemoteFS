...
## Bundled notices: ios-1.2.0-16

[Component inventory and license file references](notices/ios-1.2.0-16/index.json). Exact older inventories remain inside the matching release kits.

## Bundled notices: macos-1.2.0-2026.9.18

[Component inventory and license file references](notices/macos-1.2.0-2026.9.18/index.json). Exact older inventories remain inside the matching release kits.

[Browse macos-1.2.0-2026.9.18 license documents](notices-macos-1.2.0-2026.9.18.html)

[Browse ios-1.2.0-16 license documents](notices-ios-1.2.0-16.html)
